...
import { MaisonRegisterForm } from '@/modules/cereus/components/maison-register-form';

export default async function MaisonRegisterPage({
  params,
}: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-gray-50 to-gray-100 p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <MaisonRegisterForm accentColor={accentColor} />
      </div>
    </div>
  );
}
