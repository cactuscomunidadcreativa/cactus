...
/**
 * Public preview route for the Six Seconds Latam Operating Platform.
 * No auth required — used for stakeholder review.
 *
  ...
  return (
    <div className="min-h-screen">
      <div className="bg-amber-50 border-b border-amber-200 px-4 py-2 text-xs text-amber-800 text-center">
        🔍 PREVIEW PÚBLICO — Six Seconds Latam Operating Platform. La versión con auth real vive en{' '}
