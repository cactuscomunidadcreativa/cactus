          ...
          {subStep === 1 && (
            <div>
              ...
              <p className="text-sm text-stone-500 mb-4">
                Elige el tipo de prenda, describe tu idea y genera
              </p>
              ...
              {/* Brief + Generate - only after selecting template */}
              {selectedTemplate && (
                <div className="mt-5 p-4 bg-cereus-gold/5 border border-cereus-gold/20 rounded-xl space-y-4">
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Describe lo que quieres crear... Ej: Vestido largo de seda con escote en V, espalda descubierta, corte sirena. Inspirado en los atardeceres de Lima. Para gala de noche."
                      rows={3}
              ...
              {selectedTemplate && (
                <div className="mt-4 flex justify-center">
                  <button
                    onClick={() => generateBrief(selectedTemplate)}
                    disabled={generatingBrief}
                    className="flex items-center gap-2 px-8 py-3 bg-cereus-gold text-white rounded-xl text-sm font-semibold hover:bg-cereus-gold/90 disabled:opacity-50 shadow-lg hover:shadow-xl transition-all"
                  >
                    {generatingBrief ? (
                    ...
                    {generatingBrief ? (aiPhase || 'Generando...') : 'Generar Diseño'}
                  </button>
                </div>
              )}
